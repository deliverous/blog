...
Nous ajoutons aussi un script utilitaire, qui permetra de configurer `git` pour
un utilisateur (nom et email de l'auteur des commits) une fois que vous serez
...
On installe [`pelican`](https://github.com/getpelican/pelican) avec ses dépendances. Nous l'utilisons pour notre blog.
...
Et voila, notre bassine de travail est prête à être lancée.
