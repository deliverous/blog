...
*bassine*. /ut7 vous parle plus en détail de l'origine des *bassines* sur leur
[blog](http://ut7.fr/posts/blog/2014/11/06/bassine-de-travail.html) mais pour
faire simple, dison que c'est un espace de travail crée à l'occassion de chaque
session de programmation : chacun se connecte en `ssh` et nous utilisons
