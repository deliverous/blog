...
Ne pas oublier de mettre les bon droits sur les différents fichiers ajoutés.
...
On installe [pelican](https://github.com/getpelican/pelican) avec ses dépendances. Nous utilisons `pelican` pour la génération de notre blog.
