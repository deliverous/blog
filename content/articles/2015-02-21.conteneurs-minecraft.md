...
Alors que dans le Dockerfile, tout est installé dans `/opt/minecraft`, au démarrage, le conteneur copie l'installation de Minecraft dans le volume `/minecraft`. Ainsi les mondes peuvent être persistants.
